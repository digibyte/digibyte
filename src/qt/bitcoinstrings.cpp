...
QT_TRANSLATE_NOOP("digibyte-core", "(default: %s)"),
QT_TRANSLATE_NOOP("digibyte-core", "(default: %u)"),
QT_TRANSLATE_NOOP("digibyte-core", "(press q to shutdown and continue later)"),
...
QT_TRANSLATE_NOOP("digibyte-core", "Accept public REST requests (default: %u)"),
...
QT_TRANSLATE_NOOP("digibyte-core", "Always query for peer addresses via DNS lookup (default: %u)"),
QT_TRANSLATE_NOOP("digibyte-core", "Append comment to the user agent string"),
QT_TRANSLATE_NOOP("digibyte-core", "Attempt to recover private keys from a corrupt wallet on startup"),
QT_TRANSLATE_NOOP("digibyte-core", "Automatically create Tor hidden service (default: %d)"),
...
QT_TRANSLATE_NOOP("digibyte-core", "Enable publish hash block in <address>"),
QT_TRANSLATE_NOOP("digibyte-core", "Enable publish hash transaction in <address>"),
QT_TRANSLATE_NOOP("digibyte-core", "Enable publish raw block in <address>"),
QT_TRANSLATE_NOOP("digibyte-core", "Enable publish raw transaction in <address>"),
QT_TRANSLATE_NOOP("digibyte-core", "Enable transaction replacement in the memory pool (default: %u)"),
...
QT_TRANSLATE_NOOP("digibyte-core", "Error loading wallet %s. -wallet filename must be a regular file."),
QT_TRANSLATE_NOOP("digibyte-core", "Error loading wallet %s. Duplicate -wallet filename specified."),
QT_TRANSLATE_NOOP("digibyte-core", "Error loading wallet %s. Invalid characters in -wallet filename."),
...
QT_TRANSLATE_NOOP("digibyte-core", "Fee (in %s/kB) to add to transactions you send (default: %s)"),
QT_TRANSLATE_NOOP("digibyte-core", "How many blocks to check at startup (default: %u, 0 = all)"),
QT_TRANSLATE_NOOP("digibyte-core", "Importing..."),
QT_TRANSLATE_NOOP("digibyte-core", "Imports blocks from external blk000??.dat file on startup"),
QT_TRANSLATE_NOOP("digibyte-core", "Include IP addresses in debug output (default: %u)"),
...
QT_TRANSLATE_NOOP("digibyte-core", "Keep at most <n> unconnectable transactions in memory (default: %u)"),
QT_TRANSLATE_NOOP("digibyte-core", "Keep the transaction memory pool below <n> megabytes (default: %u)"),
QT_TRANSLATE_NOOP("digibyte-core", "Keypool ran out, please call keypoolrefill first"),
QT_TRANSLATE_NOOP("digibyte-core", "Listen for JSON-RPC connections on <port> (default: %u or testnet: %u)"),
QT_TRANSLATE_NOOP("digibyte-core", "Listen for connections on <port> (default: %u or testnet: %u)"),
...
QT_TRANSLATE_NOOP("digibyte-core", "Location of the auth cookie (default: data dir)"),
QT_TRANSLATE_NOOP("digibyte-core", "Maintain at most <n> connections to peers (default: %u)"),
QT_TRANSLATE_NOOP("digibyte-core", "Make the wallet broadcast transactions"),
QT_TRANSLATE_NOOP("digibyte-core", "Maximum per-connection receive buffer, <n>*1000 bytes (default: %u)"),
QT_TRANSLATE_NOOP("digibyte-core", "Maximum per-connection send buffer, <n>*1000 bytes (default: %u)"),
QT_TRANSLATE_NOOP("digibyte-core", "Need to specify a port with -whitebind: '%s'"),
QT_TRANSLATE_NOOP("digibyte-core", "Node relay options:"),
QT_TRANSLATE_NOOP("digibyte-core", "Not enough file descriptors available."),
QT_TRANSLATE_NOOP("digibyte-core", "Only connect to nodes in network <net> (ipv4, ipv6 or onion)"),
QT_TRANSLATE_NOOP("digibyte-core", "Options:"),
QT_TRANSLATE_NOOP("digibyte-core", "Password for JSON-RPC connections"),
QT_TRANSLATE_NOOP("digibyte-core", "Prepend debug output with timestamp (default: %u)"),
QT_TRANSLATE_NOOP("digibyte-core", "Print this help message and exit"),
QT_TRANSLATE_NOOP("digibyte-core", "Print version and exit"),
...
QT_TRANSLATE_NOOP("digibyte-core", "RPC server options:"),
QT_TRANSLATE_NOOP("digibyte-core", "Rebuild chain state and block index from the blk*.dat files on disk"),
QT_TRANSLATE_NOOP("digibyte-core", "Rebuild chain state from the currently indexed blocks"),
QT_TRANSLATE_NOOP("digibyte-core", "Reducing -maxconnections from %d to %d, because of system limitations."),
QT_TRANSLATE_NOOP("digibyte-core", "Relay and mine data carrier transactions (default: %u)"),
QT_TRANSLATE_NOOP("digibyte-core", "Relay non-P2SH multisig (default: %u)"),
QT_TRANSLATE_NOOP("digibyte-core", "Replaying blocks..."),
QT_TRANSLATE_NOOP("digibyte-core", "Rescan the block chain for missing wallet transactions on startup"),
...
QT_TRANSLATE_NOOP("digibyte-core", "Send transactions with full-RBF opt-in enabled (default: %u)"),
QT_TRANSLATE_NOOP("digibyte-core", "Set database cache size in megabytes (%d to %d, default: %d)"),
QT_TRANSLATE_NOOP("digibyte-core", "Set key pool size to <n> (default: %u)"),
QT_TRANSLATE_NOOP("digibyte-core", "Set maximum BIP141 block weight (default: %d)"),
QT_TRANSLATE_NOOP("digibyte-core", "Set maximum block size in bytes (default: %d)"),
QT_TRANSLATE_NOOP("digibyte-core", "Set the number of threads to service RPC calls (default: %d)"),
QT_TRANSLATE_NOOP("digibyte-core", "Show all debugging options (usage: --help -help-debug)"),
...
QT_TRANSLATE_NOOP("digibyte-core", "Specify configuration file (default: %s)"),
QT_TRANSLATE_NOOP("digibyte-core", "Specify connection timeout in milliseconds (minimum: 1, default: %d)"),
QT_TRANSLATE_NOOP("digibyte-core", "Specify data directory"),
QT_TRANSLATE_NOOP("digibyte-core", "Specify pid file (default: %s)"),
...
QT_TRANSLATE_NOOP("digibyte-core", "Spend unconfirmed change when sending transactions (default: %u)"),
...
QT_TRANSLATE_NOOP("digibyte-core", "Threshold for disconnecting misbehaving peers (default: %u)"),
QT_TRANSLATE_NOOP("digibyte-core", "Tor control port password (default: empty)"),
QT_TRANSLATE_NOOP("digibyte-core", "Tor control port to use if onion listening enabled (default: %s)"),
...
QT_TRANSLATE_NOOP("digibyte-core", "Upgrade wallet to latest format on startup"),
QT_TRANSLATE_NOOP("digibyte-core", "Upgrading UTXO database"),
QT_TRANSLATE_NOOP("digibyte-core", "Use UPnP to map the listening port (default: %u)"),
QT_TRANSLATE_NOOP("digibyte-core", "Use the test chain"),
...
QT_TRANSLATE_NOOP("digibyte-core", "Wallet debugging/testing options:"),
...
QT_TRANSLATE_NOOP("digibyte-core", "Whether to operate in a blocks only mode (default: %u)"),
...
QT_TRANSLATE_NOOP("digibyte-core", "ZeroMQ notification options:"),
};
