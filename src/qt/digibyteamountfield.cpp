...
public:
    ...
    void setDisplayUnit(int unit)
    {
        ...
        currentUnit = unit;
        lineEdit()->setPlaceholderText(DigiByteUnits::format(currentUnit, m_min_amount, false, DigiByteUnits::separatorAlways));
        if(valid)
            setValue(val);
        else
            clear();
    ...
    QSize minimumSizeHint() const
    {
        if(cachedMinimumSizeHint.isEmpty())
        {
            ...
            int w = GUIUtil::TextWidth(fm, DigiByteUnits::format(DigiByteUnits::DGB, DigiByteUnits::maxMoney(), false, DigiByteUnits::separatorAlways));
    ...
    amount(nullptr)
{
    ...
    connect(unit, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged), this, &DigiByteAmountField::unitChanged);
