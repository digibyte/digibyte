...
QT_TRANSLATE_NOOP("digibyte-core", "Error loading %s: You can't disable HD on a already existing HD wallet"),
...
QT_TRANSLATE_NOOP("digibyte-core", "Send transactions as zero-fee transactions if possible (default: %u)"),
