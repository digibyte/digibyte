...
QT_TRANSLATE_NOOP("digibyte-core", "SQLiteDatabase: Failed to fetch sqlite wallet schema version: %s"),
QT_TRANSLATE_NOOP("digibyte-core", "SQLiteDatabase: Failed to fetch the application id: %s"),
