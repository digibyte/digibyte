...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        {
            // First part of help message is specific to zetacoind / RPC client
            std::string strUsage = _("Zetacoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  zetacoind [options]                     " + "\n" +
                  "  zetacoind [options] <command> [params]  " + _("Send command to -server or zetacoind") + "\n" +
