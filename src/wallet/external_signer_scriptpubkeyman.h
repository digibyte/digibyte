...
#ifndef DIGIBYTE_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define DIGIBYTE_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // DIGIBYTE_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
