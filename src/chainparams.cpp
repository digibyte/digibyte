...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("digibyte.co seed #1", "digibyte.co"));
        vSeeds.push_back(CDNSSeedData("digiexplorer.info seed #1", "digiexplorer.info"));
        vSeeds.push_back(CDNSSeedData("digihash.co seed #3", "digihash.co"));
