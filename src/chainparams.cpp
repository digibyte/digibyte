...
public:
    CMainParams() {
        ...
        **/
        ...
        consensus.alwaysUpdateDiffChangeTarget = 140;
        consensus.workComputationChangeTarget = 160; 
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_NVERSIONBIPS].nStartTime = 1489585416; // October 22nd, 2020
        consensus.vDeployments[Consensus::DEPLOYMENT_NVERSIONBIPS].nTimeout = 1521121411;    // October 22nd, 2021

        // Deployment of BIP68, BIP112, and BIP113.
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].bit = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 1489585416; // October 22nd, 2020
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 1521121411; // October 22nd, 2021

        // Deployment of SegWit (BIP141, BIP143, and BIP147)
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].bit = 1;
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nStartTime = 1489585416; // October 22nd, 2020.
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 1521121411; // October 22nd, 2021.

        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("0x00");

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x7497ea1b465eb39f1c8f507bc877078fe016d6fcb6dfad3a64c98dcc6e1e8496"); // Block 4,096,666
