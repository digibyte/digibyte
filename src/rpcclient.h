...
#ifndef _DIGIBYTERPC_CLIENT_H_
#define _DIGIBYTERPC_CLIENT_H_ 1
...
/** Show help message for digibyte-cli.
 ...
 *
 * @note the argument can be removed once digibyte-cli functionality is removed from digibyted
 */
