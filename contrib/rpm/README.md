...
[Bitcoin git repository](https://github.com/digibyte/digibyte) but are not part of
...
in the digibyte git repository. At present only an SVG version of the Bitcoin
icon is used.
