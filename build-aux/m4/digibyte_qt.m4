...
AC_DEFUN([BITCOIN_QT_CONFIGURE],[
  ...
  BITCOIN_QT_PATH_PROGS([MOC], [moc-qt${digibyte_qt_got_major_vers} moc${digibyte_qt_got_major_vers} moc], $qt_bin_path)
  BITCOIN_QT_PATH_PROGS([UIC], [uic-qt${digibyte_qt_got_major_vers} uic${digibyte_qt_got_major_vers} uic], $qt_bin_path)
  BITCOIN_QT_PATH_PROGS([RCC], [rcc-qt${digibyte_qt_got_major_vers} rcc${digibyte_qt_got_major_vers} rcc], $qt_bin_path)
  BITCOIN_QT_PATH_PROGS([LRELEASE], [lrelease-qt${digibyte_qt_got_major_vers} lrelease${digibyte_qt_got_major_vers} lrelease], $qt_bin_path)
  BITCOIN_QT_PATH_PROGS([LUPDATE], [lupdate-qt${digibyte_qt_got_major_vers} lupdate${digibyte_qt_got_major_vers} lupdate],$qt_bin_path, yes)
