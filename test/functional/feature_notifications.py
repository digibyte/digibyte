...
class NotificationsTest(DigiByteTestFramework):
    ...
    def run_test(self):
        ...
        block_count = 10
        blocks = self.nodes[1].generatetoaddress(block_count, self.nodes[1].getnewaddress() if self.is_wallet_compiled() else ADDRESS_dgbrt_UNSPENDABLE)
        ...
        if self.is_wallet_compiled():
            ...
            self.nodes[0].generatetoaddress(100, ADDRESS_dgbrt_UNSPENDABLE)
            self.sync_blocks()

            # Generate transaction on node 0, sync mempools, and check for
            # notification on node 1.
            tx1 = self.nodes[0].sendtoaddress(address=ADDRESS_dgbrt_UNSPENDABLE, amount=1, replaceable=True)
            ...
            blockhash1 = self.nodes[0].generatetoaddress(1, ADDRESS_dgbrt_UNSPENDABLE)[0]
            ...
            tx2 = self.nodes[0].sendtoaddress(address=ADDRESS_dgbrt_UNSPENDABLE, amount=1, replaceable=True)
            ...
            blockhash2 = self.nodes[0].generatetoaddress(1, ADDRESS_dgbrt_UNSPENDABLE)[0]
