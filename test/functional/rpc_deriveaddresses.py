...
class DeriveaddressesTest(DigiByteTestFramework):
    ...
    def run_test(self):
        ...
        address = "dgbrtqjqmxmkpmxt80xz4y3746zgt0q3u3ferr34acd5"
        ...
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, [1, 2]), ["dgbrtqhku5rq7jz8ulufe2y6fkcpnlvpsta7rq4442dy", "dgbrtqpgptk2gvshyl0s9lqshsmx932l9ccsv265tvaq"])
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, 2), [address, "dgbrtqhku5rq7jz8ulufe2y6fkcpnlvpsta7rq4442dy", "dgbrtqpgptk2gvshyl0s9lqshsmx932l9ccsv265tvaq"])
