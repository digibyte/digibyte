...
class InitStressTest(DigiByteTestFramework):
    """
    ...
    def run_test(self):
        ...
        def check_clean_start():
            ...
            # See https://github.com/digibyte/digibyte/pull/23289#discussion_r735159180 for
        ...
        for file_patt, err_fragment in files_to_disturb.items():
            ...
            #
            # At the moment I can't get this to work (digibyted loads successfully?) so
