...
class TestShell:
    """Wrapper Class for DigiByteTestFramework.

    The TestShell class extends the DigiByteTestFramework
    ...
    class __TestShell(DigiByteTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by DigiByteTestFramework child class.
            self.num_nodes = 1
