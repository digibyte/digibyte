...
unlocked to sign the DigiByte-Qt.app bundle.
...
allowing somebody to distribute a DigiByte-Qt.app or digibyte-qt-setup.exe with a valid
...
that the digibyte-qt.exe file inside the installer had not been tampered with.
