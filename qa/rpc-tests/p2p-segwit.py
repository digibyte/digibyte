...
class SegWitTest(DigiByteTestFramework):
    ...
    def test_unnecessary_witness_before_segwit_activation(self):
        ...
        # Right now, digibyted delays sending reject messages for blocks
    ...
    # To enable this test, pass --oldbinary=<path-to-pre-segwit-digibyted> to
    # the test.
    def test_upgrade_after_activation(self, node, node_id):
        print("\tTesting software upgrade after softfork activation")

        assert(node_id != 0) # node0 is assumed to be a segwit-active digibyted
