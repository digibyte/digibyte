...
int main()
{
    ...
    auto op0Result = digibyteconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, stream.data(), stream.size(), 0, digibyteconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
