...
http://luke.dashjr.org/programs/digibyte/files/bitcoind-0.4.3/ (until Gavin uploads to SourceForge)
...
http://gitorious.org/digibyte/bitcoind-stable/archive-tarball/v0.4.3#.tar.gz
