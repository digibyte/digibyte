...
http://sourceforge.net/projects/digibyte/files/Bitcoin/digibyte-0.4.1/
...
If you have a previously encrypted wallet.dat, the first time you run wxdigibyte or digibyted the wallet will be rewritten, Bitcoin will
