DigiByte Core version 0.10.4 is now available from:
  ...
  <https://digibyte.org/bin/digibyte-core-0.10.4/>
...
- #6953 `43c2789` Split digibyte-tx into its own package
- #6953 `dfe0d4d` Include digibyte-tx binary on Debian/Ubuntu
