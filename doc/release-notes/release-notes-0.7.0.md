Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/digibyte/files/Bitcoin/digibyte-0.7.0/

We recommend that everybody running prior versions of digibyted/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/digibyte/digibyte/tarball/v0.7.0  # .tar.gz
  https://github.com/digibyte/digibyte/zipball/v0.7.0  # .zip
