DigiByte Core version 0.13.1 is now available from:
  ...
  <https://digibyte.org/bin/digibyte-core-0.13.1/>
...
- #8829 `2a8bca4` Add digibyte-tx JSON tests (jnewbery)
- #8834 `1dd1783` blockstore: Switch to dumb dbm (MarcoFalke)
- #8835 `d87227d` nulldummy.py: Don't run unused code (MarcoFalke)
- #8836 `eb18cc1` digibyte-util-test.py should fail if the output file is empty (jnewbery)
...
- #8817 `bcf3806` update digibyte-tx to output witness data (jnewbery)
