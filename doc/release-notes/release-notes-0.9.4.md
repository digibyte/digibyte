...
DigiByte Core released binaries from https://digibyte.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~digibyte/+archive/ubuntu/digibyte
