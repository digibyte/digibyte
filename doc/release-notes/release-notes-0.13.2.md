DigiByte Core version 0.13.2 is now available from:
  ...
  <https://digibyte.org/bin/digibyte-core-0.13.2/>
...
- #8908 `4a974b2` Update digibyte-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow digibyte-tx to create v2 transactions (dgbdrak)
