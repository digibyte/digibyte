DigiByte Core version 0.16.1 is now available from:
  ...
  <https://digibytecore.org/bin/digibyte-core-0.16.1/>
...
- #12843 `df38b13` Test starting digibyted with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure digibyted processes are cleaned up when tests end (sdaftuar)
