DigiByte Core version 0.11.0 is now available from:
  ...
  <https://digibyte.org/bin/digibyte-core-0.11.0/>
...
For example, add the following to `digibyte.conf`:
...
related to the blockchain in the digibyte system: the raw blocks as received over 
...
For an example script see [digibyte-submittx](https://github.com/laanwj/digibyte-submittx).
...
- #5334 `cf87536` libdigibyteconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new digibyte-detached-sigs git repo for OSX signatures
...
- #5753 `0f44672` Add digibyte logo to about screen
...
- #5809 `46bfbe7` Add digibyte-cli man page
...
- #5849 `41259ca` contrib/init/digibyted.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for digibyte-tx)
