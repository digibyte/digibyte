...
The headless daemon `digibyted` has the JSON-RPC API enabled by default, the GUI
`digibyte-qt` has it disabled by default. This can be changed with the `-server`
...
- **Securing remote network access:** You may optionally allow other
  ...
  `digibyted -help` for more information about these settings and other
